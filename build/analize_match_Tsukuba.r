...
#if (i == 1) {
png(png_name, width = 840, height = 360)
par(mar = c(5, 5, 5, 10))
plot(0:4545, txt_data[, 3], type = "l", xlim = range(0:4547), ylim = range(0:4821), xlab = "取得したフレーム番号", ylab = "マッチしたフレーム番号",col = 4, pch = c(4),cex = 4) #  
par(xpd = T)
legend(par()$usr[2] + 0.6, par()$usr[4], legend = c("相関係数",format(cor(0:4545, z.data),nsmall = 5)), col = c(4))
dev.off()
...
png(png_name, width = 840, height = 360)
par(mar = c(5, 5, 5, 10))
plot(0:4545, txt_data2[, 3], type = "l", xlim = range(0:4547), ylim = range(0:4821), xlab = "取得したフレーム番号", ylab = "マッチしたフレーム番号",col = 4, pch = c(4),cex = 4) #  
par(xpd = T)
legend(par()$usr[2] + 0.6, par()$usr[4], legend = c("相関係数",format(cor(0:4545, w.data), nsmall = 5)), pch = c(4,0,0), col = c(4))
dev.off()
...
png(png_name, width = 840, height = 360)
par(mar = c(5, 5, 5, 10))
plot(0:4545, txt_data3[, 3], type = "l", xlim = range(0:4547), ylim = range(0:4821), xlab = "取得したフレーム番号", ylab = "マッチしたフレーム番号",col = 4, pch = c(4),cex = 4) #  
par(xpd = T)
legend(par()$usr[2] + 0.6, par()$usr[4], legend = c("相関係数",format(cor(0:4545, k.data), nsmall = 5)), pch = c(4,0,0), col = c(4))
dev.off()
