...
void save(int m, int execute_num)
{
    ...
    savefile = std::ofstream(SAVE1.c_str());
    savefile << m << std::endl;
    savefile.close();
}
...
int main(int argc, char **argv)
{
    ...
    */
    ...
    dir = "gra/Tsukuba0";
    rdir = "gra/result_Canny_Tsukuba0";
    tag = ".png";
    ...
    location_path = "gra/r_file/location_Canny.csv";
